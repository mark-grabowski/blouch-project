...
#Uncommmet for for Fig2
#fig<-ggpubr::annotate_figure(fig,top=paste("Multi-Optima Adaptive Model with Varying Effects,\n hl=",hl,sep=""))
...
#Uncomment for FigS3
#fig<-ggpubr::annotate_figure(fig,top=paste("Multilevel Multi-Optima Adaptive Model with Varying Effects,\n hl=",hl,sep=""))
ggplot2::ggsave("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch Project - SBR2/Blouch ms/R2/Figures/FigS3.pdf", plot = fig, width=7, height=7 )
