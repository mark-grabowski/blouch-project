...
# Save this file as `R/blouchOU.setup.v4.R`

#' This is the R setup file for blouchOU_v4.stan
#' 
#' @importFrom stats lm
...
#' @return An object of class list for use in blouchOU_v1_9.stan
#' @export

blouchOU.setup.mv<-function(trdata,name.response.trait,names.direct.traits=NULL,names.random.traits=NULL,names.response.me.trait=NULL,names.direct.me.traits=NULL,names.random.me.traits=NULL,trend=0){
  ...
  #Works with blouchOU_v1_9.stan code, including trend model
