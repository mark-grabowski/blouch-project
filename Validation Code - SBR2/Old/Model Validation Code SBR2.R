...
ggplot2::ggsave("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch Project - SBR2/Blouch ms/R2/Latex Documents/Figures/Validation/Valid_Fig37.pdf", plot = fig, width=10.5, height=7 )
########################################################################################################
#set.seed(10) #Set seed to get same random species each time
N<-50 #Number of species
Z_direct<-1
...
fig<-ggpubr::ggarrange(hl.plot, vy.plot,covariance.plot,regression.plot[[1]],regression.plot[[2]],ncol=3,nrow=2, labels = c("A)","B)","C)","D)","E)"),common.legend = TRUE,legend="top")
fig<-ggpubr::annotate_figure(fig,top=paste("Multi-Optima Direct EFfect + Adaptation Model, hl=",hl,sep=""))
ggplot2::ggsave("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch Project - SBR2/Blouch ms/R2/Latex Documents/Figures/Validation/Valid_Fig38.pdf", plot = fig, width=10.5, height=7 )
########################################################################################################
#set.seed(10) #Set seed to get same random species each time
N<-50 #Number of species
Z_direct<-1
...
fig<-ggpubr::ggarrange(hl.plot, vy.plot,covariance.plot,regression.plot[[1]],regression.plot[[2]],ncol=3,nrow=2, labels = c("A)","B)","C)","D)","E)"),common.legend = TRUE,legend="top")
fig<-ggpubr::annotate_figure(fig,top=paste("Multi-Optima Direct EFfect + Adaptation Model, hl=",hl,sep=""))
ggplot2::ggsave("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch Project - SBR2/Blouch ms/R2/Latex Documents/Figures/Validation/Valid_Fig39.pdf", plot = fig, width=10.5, height=7 )
...
ggplot2::ggsave("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch Project - SBR2/Blouch ms/R2/Latex Documents/Figures/Validation/Valid_Fig40.pdf", plot = fig, width=10.5, height=7 )
############################################################################################################
N<-50 #Number of species
Z_direct<-1
Z_adapt<-1
...
fig<-ggpubr::ggarrange(hl.plot, vy.plot,covariance.plot,regression.plot[[1]],regression.plot[[2]],ncol=3,nrow=2, labels = c("A)","B)","C)","D)","E)"),common.legend = TRUE,legend="top")
fig<-ggpubr::annotate_figure(fig,top=paste("Multilevel Multi-Optima Direct Effect + Adaptation Model - Varying Intercepts, hl=",hl,sep=""))
ggplot2::ggsave("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch Project - SBR2/Blouch ms/R2/Latex Documents/Figures/Validation/Valid_Fig41.pdf", plot = fig, width=10.5, height=7 )
############################################################################################################
N<-50 #Number of species
Z_direct<-1
Z_adapt<-1
...
fig<-ggpubr::ggarrange(hl.plot, vy.plot,covariance.plot,regression.plot[[1]],regression.plot[[2]],ncol=3,nrow=2, labels = c("A)","B)","C)","D)","E)"),common.legend = TRUE,legend="top")
fig<-ggpubr::annotate_figure(fig,top=paste("Multilevel Multi-Optima Direct Effect + Adaptation Model - Varying Intercepts, hl=",hl,sep=""))
ggplot2::ggsave("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch Project - SBR2/Blouch ms/R2/Latex Documents/Figures/Validation/Valid_Fig42.pdf", plot = fig, width=10.5, height=7 )

############################################################################################################
############################################################################################################
#Multilevel Multi-Optima Direct Effect + Adaptation Model - Varying Intercepts - Non-centeded
############################################################################################################
N<-50 #Number of species
Z_direct<-1
Z_adapt<-1
...
ggplot2::ggsave("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch Project - SBR2/Blouch ms/R2/Latex Documents/Figures/Validation/Valid_Fig43.pdf", plot = fig, width=10.5, height=7 )
############################################################################################################
N<-50 #Number of species
Z_direct<-1
Z_adapt<-1
...
fig<-ggpubr::ggarrange(hl.plot, vy.plot,covariance.plot,regression.plot[[1]],regression.plot[[2]],ncol=3,nrow=2, labels = c("A)","B)","C)","D)","E)"),common.legend = TRUE,legend="top")
fig<-ggpubr::annotate_figure(fig,top=paste("Multilevel Multi-Optima Direct Effect + Adaptation Model - Varying Intercepts - Non-centered, hl=",hl,sep=""))
ggplot2::ggsave("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch Project - SBR2/Blouch ms/R2/Latex Documents/Figures/Validation/Valid_Fig44.pdf", plot = fig, width=10.5, height=7 )
############################################################################################################
N<-50 #Number of species
Z_direct<-1
Z_adapt<-1
...
fig<-ggpubr::ggarrange(hl.plot, vy.plot,covariance.plot,regression.plot[[1]],regression.plot[[2]],ncol=3,nrow=2, labels = c("A)","B)","C)","D)","E)"),common.legend = TRUE,legend="top")
fig<-ggpubr::annotate_figure(fig,top=paste("Multilevel Multi-Optima Direct Effect + Adaptation Model - Varying Intercepts - Non-centered, hl=",hl,sep=""))
ggplot2::ggsave("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch Project - SBR2/Blouch ms/R2/Latex Documents/Figures/Validation/Valid_Fig45.pdf", plot = fig, width=10.5, height=7 )
############################################################################################################
########################################################################################################
...
ggplot2::ggsave("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch Project - SBR2/Blouch ms/R2/Latex Documents/Figures/Validation/Valid_Fig55.pdf", plot = fig, width=7, height=7 )
########################################################################################################
N<-50
Z_adaptive<-1
hl<-0.25 #0.1, 0.25, 0.75 - testing options
...
fig<-ggpubr::ggarrange(hl.plot, vy.plot,covariance.plot,regression.plot,ncol=2,nrow=2, labels = c("A)","B)","C)","D)"),common.legend = TRUE,legend="top")
fig<-ggpubr::annotate_figure(fig,top=paste("Multi-Optima Adaptive Model - Varying Effects, hl=",hl,sep=""))
ggplot2::ggsave("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch Project - SBR2/Blouch ms/R2/Latex Documents/Figures/Validation/Valid_Fig56.pdf", plot = fig, width=7, height=7 )
########################################################################################################
N<-50
Z_adaptive<-1
hl<-0.75 #0.1, 0.25, 0.75 - testing options
...
fig<-ggpubr::ggarrange(hl.plot, vy.plot,covariance.plot,regression.plot,ncol=2,nrow=2, labels = c("A)","B)","C)","D)"),common.legend = TRUE,legend="top")
fig<-ggpubr::annotate_figure(fig,top=paste("Multi-Optima Adaptive Model - Varying Effects, hl=",hl,sep=""))
ggplot2::ggsave("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch Project - SBR2/Blouch ms/R2/Latex Documents/Figures/Validation/Valid_Fig57.pdf", plot = fig, width=7, height=7 )
########################################################################################################
############################################################################################################
...
ggplot2::ggsave("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch Project - SBR2/Blouch ms/R2/Latex Documents/Figures/Validation/Valid_Fig58.pdf", plot = fig, width=7, height=7 )
############################################################################################################
N<-50
Z_adaptive<-1
hl<-0.25 #0.1, 0.25, 0.75 - testing options
...
fig<-ggpubr::ggarrange(hl.plot, vy.plot,covariance.plot,regression.plot,ncol=2,nrow=2, labels = c("A)","B)","C)","D)"),common.legend = TRUE,legend="top")
fig<-ggpubr::annotate_figure(fig,top=paste("Multilevel Multi-Optima Adaptive Model - Varying Effects, hl=",hl,sep=""))
ggplot2::ggsave("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch Project - SBR2/Blouch ms/R2/Latex Documents/Figures/Validation/Valid_Fig59.pdf", plot = fig, width=7, height=7 )
############################################################################################################
N<-50
Z_adaptive<-1
hl<-0.75 #0.1, 0.25, 0.75 - testing options
...
fig<-ggpubr::ggarrange(hl.plot, vy.plot,covariance.plot,regression.plot,ncol=2,nrow=2, labels = c("A)","B)","C)","D)"),common.legend = TRUE,legend="top")
fig<-ggpubr::annotate_figure(fig,top=paste("Multilevel Multi-Optima Adaptive Model - Varying Effects, hl=",hl,sep=""))
ggplot2::ggsave("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch Project - SBR2/Blouch ms/R2/Latex Documents/Figures/Validation/Valid_Fig60.pdf", plot = fig, width=7, height=7 )
############################################################################################################
############################################################################################################
...
ggplot2::ggsave("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch Project - SBR2/Blouch ms/R2/Latex Documents/Figures/Validation/Valid_Fig61.pdf", plot = fig, width=7, height=7 )
############################################################################################################
N<-50
Z_adaptive<-1
hl<-0.25 #0.1, 0.25, 0.75 - testing options
...
fig<-ggpubr::ggarrange(hl.plot, vy.plot,covariance.plot,regression.plot,ncol=2,nrow=2, labels = c("A)","B)","C)","D)"),common.legend = TRUE,legend="top")
fig<-ggpubr::annotate_figure(fig,top=paste("Multilevel Multi-Optima Adaptive Model - Varying Effects - Non-centered, hl=",hl,sep=""))
ggplot2::ggsave("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch Project - SBR2/Blouch ms/R2/Latex Documents/Figures/Validation/Valid_Fig62.pdf", plot = fig, width=7, height=7 )
############################################################################################################
N<-50
Z_adaptive<-1
hl<-0.75 #0.1, 0.25, 0.75 - testing options
...
fig<-ggpubr::ggarrange(hl.plot, vy.plot,covariance.plot,regression.plot,ncol=2,nrow=2, labels = c("A)","B)","C)","D)"),common.legend = TRUE,legend="top")
fig<-ggpubr::annotate_figure(fig,top=paste("Multilevel Multi-Optima Adaptive Model - Varying Effects - Non-centered, hl=",hl,sep=""))
ggplot2::ggsave("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch Project - SBR2/Blouch ms/R2/Latex Documents/Figures/Validation/Valid_Fig63.pdf", plot = fig, width=7, height=7 )
############################################################################################################
########################################################################################################
...
vy.prior.plot.code(vy.prior)
covariance.prior.adapt.plot.code(hl.prior,vy.prior,beta.prior)
#optima.direct.adapt.ve.prior.post.plot.code(trdata,optima.prior,beta.prior,optima,beta)
########################################################################################################
dat<-blouch.reg.direct.adapt.prep(trdata,"Y_with_error","Y_error",c("Xd","Xa"),c("Xd_error","Xa_error"),Z_direct=1,Z_adaptive=1,"regimes",hl.prior,vy.prior,optima.prior,beta.prior)
########################################################################################################
#Multi-Optima Direct Effect + Adaptation Model - Varying Effects
