...
#Multi-Optima Adaptation Model
  ...
  fig<-ggpubr::ggarrange(hl.plot, vy.plot,covariance.plot,regression.plot,ncol=2,nrow=2, labels = c("A)","B)","C)","D)"),common.legend = TRUE,legend="top")
  fig<-ggpubr::annotate_figure(fig,top=paste("Multi-Optima Adaptive Model - Varying Effects, hl=",hl,sep=""))
  ggplot2::ggsave("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch Project - SBR2/Blouch ms/R2/Latex Documents/Figures/Validation/Valid_Fig73.pdf", plot = fig, width=7, height=7 )
  ########################################################################################################
  N<-50
  Z_adaptive<-1
  hl<-0.25 #0.1, 0.25, 0.75 - testing options
  ...
  fig<-ggpubr::ggarrange(hl.plot, vy.plot,covariance.plot,regression.plot,ncol=2,nrow=2, labels = c("A)","B)","C)","D)"),common.legend = TRUE,legend="top")
  fig<-ggpubr::annotate_figure(fig,top=paste("Multi-Optima Adaptive Model - Varying Effects, hl=",hl,sep=""))
  ggplot2::ggsave("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch Project - SBR2/Blouch ms/R2/Latex Documents/Figures/Validation/Valid_Fig74.pdf", plot = fig, width=7, height=7 )
  ########################################################################################################
  N<-50
  Z_adaptive<-1
  hl<-0.75 #0.1, 0.25, 0.75 - testing options
  ...
  fig<-ggpubr::ggarrange(hl.plot, vy.plot,covariance.plot,regression.plot,ncol=2,nrow=2, labels = c("A)","B)","C)","D)"),common.legend = TRUE,legend="top")
  fig<-ggpubr::annotate_figure(fig,top=paste("Multi-Optima Adaptive Model - Varying Effects, hl=",hl,sep=""))
  ggplot2::ggsave("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch Project - SBR2/Blouch ms/R2/Latex Documents/Figures/Validation/Valid_Fig75.pdf", plot = fig, width=7, height=7 )
  ########################################################################################################
  ############################################################################################################
  #Multilevel Multi-Optima Adaptation Model - Varying Effects
  N<-50
  ...
  fig<-ggpubr::ggarrange(hl.plot, vy.plot,covariance.plot,regression.plot,ncol=2,nrow=2, labels = c("A)","B)","C)","D)"),common.legend = TRUE,legend="top")
  fig<-ggpubr::annotate_figure(fig,top=paste("Multilevel Multi-Optima Adaptive Model - Varying Effects, hl=",hl,sep=""))
  ggplot2::ggsave("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch Project - SBR2/Blouch ms/R2/Latex Documents/Figures/Validation/Valid_Fig76.pdf", plot = fig, width=7, height=7 )
  ############################################################################################################
  N<-50
  Z_adaptive<-1
  hl<-0.25 #0.1, 0.25, 0.75 - testing options
  ...
  fig<-ggpubr::ggarrange(hl.plot, vy.plot,covariance.plot,regression.plot,ncol=2,nrow=2, labels = c("A)","B)","C)","D)"),common.legend = TRUE,legend="top")
  fig<-ggpubr::annotate_figure(fig,top=paste("Multilevel Multi-Optima Adaptive Model - Varying Effects, hl=",hl,sep=""))
  ggplot2::ggsave("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch Project - SBR2/Blouch ms/R2/Latex Documents/Figures/Validation/Valid_Fig77.pdf", plot = fig, width=7, height=7 )
  ############################################################################################################
  N<-50
  Z_adaptive<-1
  hl<-0.75 #0.1, 0.25, 0.75 - testing options
  ...
  fig<-ggpubr::ggarrange(hl.plot, vy.plot,covariance.plot,regression.plot,ncol=2,nrow=2, labels = c("A)","B)","C)","D)"),common.legend = TRUE,legend="top")
  fig<-ggpubr::annotate_figure(fig,top=paste("Multilevel Multi-Optima Adaptive Model - Varying Effects, hl=",hl,sep=""))
  ggplot2::ggsave("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch Project - SBR2/Blouch ms/R2/Latex Documents/Figures/Validation/Valid_Fig78.pdf", plot = fig, width=7, height=7 )
  ############################################################################################################
  ############################################################################################################
  #Multilevel Multi-Optima Adaptation Model - Varying Effects - Non-centered
  N<-50
  ...
  fig<-ggpubr::ggarrange(hl.plot, vy.plot,covariance.plot,regression.plot,ncol=2,nrow=2, labels = c("A)","B)","C)","D)"),common.legend = TRUE,legend="top")
  fig<-ggpubr::annotate_figure(fig,top=paste("Multilevel Multi-Optima Adaptive Model - Varying Effects - Non-centered, hl=",hl,sep=""))
  ggplot2::ggsave("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch Project - SBR2/Blouch ms/R2/Latex Documents/Figures/Validation/Valid_Fig79.pdf", plot = fig, width=7, height=7 )
  ############################################################################################################
  N<-50
  Z_adaptive<-1
  hl<-0.25 #0.1, 0.25, 0.75 - testing options
  ...
  fig<-ggpubr::ggarrange(hl.plot, vy.plot,covariance.plot,regression.plot,ncol=2,nrow=2, labels = c("A)","B)","C)","D)"),common.legend = TRUE,legend="top")
  fig<-ggpubr::annotate_figure(fig,top=paste("Multilevel Multi-Optima Adaptive Model - Varying Effects - Non-centered, hl=",hl,sep=""))
  ggplot2::ggsave("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch Project - SBR2/Blouch ms/R2/Latex Documents/Figures/Validation/Valid_Fig80.pdf", plot = fig, width=7, height=7 )
  ############################################################################################################
  N<-50
  Z_adaptive<-1
  hl<-0.75 #0.1, 0.25, 0.75 - testing options
  ...
  fig<-ggpubr::ggarrange(hl.plot, vy.plot,covariance.plot,regression.plot,ncol=2,nrow=2, labels = c("A)","B)","C)","D)"),common.legend = TRUE,legend="top")
  fig<-ggpubr::annotate_figure(fig,top=paste("Multilevel Multi-Optima Adaptive Model - Varying Effects - Non-centered, hl=",hl,sep=""))
  ggplot2::ggsave("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch Project - SBR2/Blouch ms/R2/Latex Documents/Figures/Validation/Valid_Fig81.pdf", plot = fig, width=7, height=7 )
  ############################################################################################################
  ########################################################################################################
  ...
  ggplot2::ggsave("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch Project - SBR2/Blouch ms/R2/Latex Documents/Figures/Validation/Valid_Fig82.pdf", plot = fig, width=7, height=7 )
  ############################################################################################################
  N<-50
  Z_direct<-1
  Z_adaptive<-1
  ...
  fig<-ggpubr::ggarrange(hl.plot, vy.plot,covariance.plot,regression.plot,ncol=2,nrow=2, labels = c("A)","B)","C)","D)"),common.legend = TRUE,legend="top")
  fig<-ggpubr::annotate_figure(fig,top=paste("Multi-Optima Direct Effect + Adaptive Model - Varying Effects, hl=",hl,sep=""))
  ggplot2::ggsave("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch Project - SBR2/Blouch ms/R2/Latex Documents/Figures/Validation/Valid_Fig83.pdf", plot = fig, width=7, height=7 )
  ############################################################################################################
  N<-50
  Z_direct<-1
  Z_adaptive<-1
  ...
  fig<-ggpubr::ggarrange(hl.plot, vy.plot,covariance.plot,regression.plot,ncol=2,nrow=2, labels = c("A)","B)","C)","D)"),common.legend = TRUE,legend="top")
  fig<-ggpubr::annotate_figure(fig,top=paste("Multi-Optima Direct Effect + Adaptive Model - Varying Effects, hl=",hl,sep=""))
  ggplot2::ggsave("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch Project - SBR2/Blouch ms/R2/Latex Documents/Figures/Validation/Valid_Fig84.pdf", plot = fig, width=7, height=7 )
  ############################################################################################################
  ########################################################################################################
  ...
  ggplot2::ggsave("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch Project - SBR2/Blouch ms/R2/Latex Documents/Figures/Validation/Valid_Fig85.pdf", plot = fig, width=7, height=7 )
  ############################################################################################################
  Z_direct<-1
  Z_adaptive<-1
  hl<-0.25 #0.1, 0.25, 0.75 - testing options
  ...
  fig<-ggpubr::ggarrange(hl.plot, vy.plot,covariance.plot,regression.plot,ncol=2,nrow=2, labels = c("A)","B)","C)","D)"),common.legend = TRUE,legend="top")
  fig<-ggpubr::annotate_figure(fig,top=paste("Multilevel Multi-Optima Direct Effect + Adaptive Model - Varying Effects, hl=",hl,sep=""))
  ggplot2::ggsave("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch Project - SBR2/Blouch ms/R2/Latex Documents/Figures/Validation/Valid_Fig86.pdf", plot = fig, width=7, height=7 )
  ########################################################################################################
  Z_direct<-1
  Z_adaptive<-1
  hl<-0.75 #0.1, 0.25, 0.75 - testing options
  ...
  fig<-ggpubr::ggarrange(hl.plot, vy.plot,covariance.plot,regression.plot,ncol=2,nrow=2, labels = c("A)","B)","C)","D)"),common.legend = TRUE,legend="top")
  fig<-ggpubr::annotate_figure(fig,top=paste("Multilevel Multi-Optima Direct Effect + Adaptive Model - Varying Effects, hl=",hl,sep=""))
  ggplot2::ggsave("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch Project - SBR2/Blouch ms/R2/Latex Documents/Figures/Validation/Valid_Fig87.pdf", plot = fig, width=7, height=7 )
  ############################################################################################################
  ########################################################################################################
  ...
  ggplot2::ggsave("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch Project - SBR2/Blouch ms/R2/Latex Documents/Figures/Validation/Valid_Fig88.pdf", plot = fig, width=7, height=7 )
  ############################################################################################################
  Z_direct<-1
  Z_adaptive<-1
  hl<-0.25 #0.1, 0.25, 0.75 - testing options
  ...
  fig<-ggpubr::ggarrange(hl.plot, vy.plot,covariance.plot,regression.plot,ncol=2,nrow=2, labels = c("A)","B)","C)","D)"),common.legend = TRUE,legend="top")
  fig<-ggpubr::annotate_figure(fig,top=paste("Multilevel Multi-Optima Direct Effect + Adaptive Model - Varying Effects - Non-centered, hl=",hl,sep=""))
  ggplot2::ggsave("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch Project - SBR2/Blouch ms/R2/Latex Documents/Figures/Validation/Valid_Fig89.pdf", plot = fig, width=7, height=7 )
  ########################################################################################################
  Z_direct<-1
  Z_adaptive<-1
  hl<-0.75 #0.1, 0.25, 0.75 - testing options
  ...
  fig<-ggpubr::ggarrange(hl.plot, vy.plot,covariance.plot,regression.plot,ncol=2,nrow=2, labels = c("A)","B)","C)","D)"),common.legend = TRUE,legend="top")
  fig<-ggpubr::annotate_figure(fig,top=paste("Multilevel Multi-Optima Direct Effect + Adaptive Model - Varying Effects - Non-centered, hl=",hl,sep=""))
  ggplot2::ggsave("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch Project - SBR2/Blouch ms/R2/Latex Documents/Figures/Validation/Valid_Fig90.pdf", plot = fig, width=7, height=7 )
  ############################################################################################################
  ############################################################################################################
