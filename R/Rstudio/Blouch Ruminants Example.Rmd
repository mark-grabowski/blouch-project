...
---
First lets install Slouch from CRAN for comparison
```{r}
...
```
For the purposes of illustrating the software, we will use a dataset of ruminant neocortices bundled with the package and a corresponding phylogenetic tree (Toljagić et al. 2017). First, we will organize the neocortex data and associated annotation data.
```{r}
...
#names.traits<-c("neocortex_area_mm2_log_mean","brain_mass_g_log_mean",NA,NA)
#Measurement Error
names.traits<-c("neocortex_area_mm2_log_mean","brain_mass_g_log_mean","neocortex_se_squared,","brain_se_squared")
...
#Mean Standardized
ruminant.trdata$dat$braincentered<-cervid.trdata$dat$brain_mass_g_log_mean-mean(cervid.trdata$dat$brain_mass_g_log_mean)
...
slouch.OU<-slouch.fit(phy = cervid.trdata$phy,
                              ...
                              response = cervid.trdata$dat$neocortex_area_mm2_log_mean,
                              direct.cov = cervid.trdata$dat$braincentered,
                              mv.response = cervid.trdata$dat$neocortex_se_squared,
                              mv.direct.cov = cervid.trdata$dat$brain_se_squared,
