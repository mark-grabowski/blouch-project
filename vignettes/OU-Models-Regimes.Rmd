...
This vignette walks you through the basic streps of running an analysis including categorical predictors in Blouch.
...
We find that the data is BF_att more likely under a model that assumes a direct effect model rather than af adaptive model.
