---
title: "Blouch SBR1 - Cervidae Testing using Fixed Regimes"
output: html_notebook
editor_options: 
  chunk_output_type: console
---
Code to simulate fixed regimes on Cervidae Tre
...
error.comparison.2reg<-repeated_optima_sim(cervid.trdata,n=10,names.traits,head(optima,-1))
