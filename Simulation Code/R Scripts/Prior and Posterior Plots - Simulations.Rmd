...
Two regimes - blouchOU_reg_direct_ME_VarSlopes.stan
Hl Plot prior vs. posterior - assume posterior has been extracted using extract(model) and stored in post
```{r}
hl.sims<-data.frame(rlnorm(n=1000,meanlog=log(0.25),sdlog=0.75))
#hl.sims<-data.frame(hl.sims[hl.sims<3])
...
#############################################################################################################################
Milestone 11: Combination Regime Model with direct effect model and varying slopes and correlated cactors
Four regimes - blouchOU_reg_direct_ME_Vs.stan
Hl Plot prior vs. posterior - assume posterior has been extracted using extract(model) and stored in post
```{r}
hl.sims<-data.frame(rlnorm(n=1000,meanlog=log(0.25),sdlog=0.75))
#hl.sims<-data.frame(hl.sims[hl.sims<3])
