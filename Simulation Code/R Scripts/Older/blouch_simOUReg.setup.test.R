...
# Save this file as `R/blouch_simOUReg.setup.v1.1.R`
...
blouchsimOUReg.setup.test<-function(trdata,names.fixed.fact,names.direct.traits=NULL,names.random.traits=NULL,names.direct.me.traits=NULL,names.random.me.traits=NULL,hl,vy,beta){
  #No response trait - to simulate Y
  ...
  #Returns list that contains set half-life values, vy, and beta for fixed regimes simulations
