...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    }else if((sum(direct_cov)!=0)&&(sum(random_cov)!=0)){
...
model {
  ...
  //k = exp(-a * T_term[1])*Ya+(1-exp(-a * T_term[1]))*b0+(1-exp(-a*T_term[1])-rho)*beta[2]*brownian_mean[1,1];
  //////////////////////////////////////////////////////////////////////////////////////////////////////
  Ya ~ normal(Ya_prior,sqrt(vy));
  b0 ~ normal(ols_intercept,0.2);

  if(sum(random_cov)!=0){
    beta[1] ~ normal(k, 0.2); //Slope originally 0.4
