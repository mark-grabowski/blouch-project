...
//Priors
  ...
  //sigma2_y ~ exponential(0.1); //Added for SBR1

  beta[1:n_regimes] ~ normal(ols_intercept,0.2); //Changed from 0.5 for Original Sub
  beta[n_regimes+1:n_regimes+Z] ~ normal(ols_slope,0.3); //Changed from 0.4 for Original Sub
