functions {
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Blouch testing - multilevel intecepts on species
//Based on Blouch v1.9 - 01.10.23
...
//Removed Ya and associated variablkes
  ...
  if(num_elements(random_cov) != 0){
      if(Z_random>1){
        ...
        s1 = beta[1+Z_direct:Z_direct+Z_random]' * sigma_squared_x * ones;
            ...
            s1 = sigma_squared_x[1,1] * (beta[Z_direct+1]^2);
            }
...
model {
  ...
  sigma2_y = vy*(2*a);
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////
  beta[1:Z] ~ normal(ols_slope, 0.1); //Slope originally 0.4
  //////////////////////////////////////////////////////////////////////////////////////////////////////
...
//Set up V matix
  ...
  //Multilevel model for partial pooling the intercepts across niches
  alpha_bar ~ normal(0,1);
  sd_alpha ~ exponential(1);
  alpha ~ normal(alpha_bar,sd_alpha);
  mu=alpha+X*beta;
  ...
  for(i in 1:Z_random){
    ...
    beta_e[i] ~ normal(beta[Z_direct+i]* rho,0.1); //Only random covariates get evolutionary regressions
