functions {
  ...
  //03.10.2023 - Adding code for Varying effects - intercept and slope
...
parameters {
  ...
  cholesky_factor_corr[n_regimes+Z] L_Omega;
  

  vector[n_regimes+Z] beta_raw; //OU beta
...
transformed parameters {
  ...
  /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    model {
      ...
      beta ~ normal(0,0.5); //Added for SBR1, multilevel model
      
      beta_bar ~ normal(ols_intercept,0.25); //Added for multilevel model - 3 regimes Prior - average slope
      ...
      for(i in 1:Z_random){ //For evolutionary regression
