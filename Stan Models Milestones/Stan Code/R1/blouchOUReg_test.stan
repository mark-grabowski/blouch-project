  ...
  /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    matrix calc_optima(real a, int n_regimes, int n_lineages, int max_node_length, matrix nodes, matrix nodes_time, 
      ...
      for(z in 1:n_regimes){
        for(i in 1:n_lineages){
          //for(j in 1:max_node_length){ //Testing leaving out
...
transformed parameters {
  ...
  /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    model {
      ...
      //beta[1:n_regimes] ~ std_normal(); //Added for SBR1, multilevel model

      beta_raw[1:n_regimes] ~ std_normal(); //Added for SBR1, multilevel model
      //beta_raw[1:n_regimes] ~ normal(0,0.5); //Added for SBR1, multilevel model
      beta_raw[n_regimes+1:n_regimes+Z] ~ normal(ols_slope,0.25); //Added for SBR1
      
      beta_bar ~ normal(ols_intercept,1); //Added for multilevel model
      sd_beta ~ exponential(1); //Added for multilevel model
