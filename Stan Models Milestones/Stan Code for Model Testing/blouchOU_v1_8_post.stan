...
/////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  beta_e_pred[1] = beta[1];
  beta_e_pred[2:Z+1] = beta_e;
  
  L_V_pred = cholesky_decompose(V_opt);
  for (i in 1:100){
    Y_pred[i,] = (multi_normal_cholesky_rng(X_evol*beta_e_pred, L_V_pred))';
  }
}
