...
name.response.trait<-paste("Sim",2,sep="")
...
fit.mli.nc.regimes<- rstan::sampling(object = stan_model,data = stan_test_data,chains = 2,iter = 2000,control=list(adapt_delta=0.9))
