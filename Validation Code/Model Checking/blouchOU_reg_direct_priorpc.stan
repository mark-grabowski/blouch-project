...
generated quantities {
  ...
  vector[n_reg+Z_direct] optima_beta;
  vector[N] Y_sim;
  matrix[N,Z_direct] X_sim;
  vector[N] Y_sim_obs;
  vector[n_reg] optima_sim;
  vector[Z_direct] beta_sim; 
  ...
  dmX = append_col(optima_matrix,X_sim); //Given measurement error in X variable, uncomment this nested statement
