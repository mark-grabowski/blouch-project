...
fit.npi.direct<- rstan::sampling(object = stan_model,data = dat,chains = 1,iter = 2000, cores=1)
...
########################################################################################################
#Milestone 4
#Regime model - single regimes - painted or SIMMAP
setwd("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Blouch project/R1 blouch-testing branch/Stan Models Milestones/Testing Versions/")
...
fit.npi.regimes<- rstan::sampling(object = stan_model,data = dat,chains = 1,iter =1000)
...
print(fit.mli.regimes,pars = c("hl","vy","optima","optima_bar","optima_sigma","sigma2_y"))
...
#First run
fit.mli.nc.regimes<- rstan::sampling(object = stan_model,data = dat,chains = 1,iter =1000, cores=1)
print(fit.mli.nc.regimes,pars = c("hl","vy","optima","optima_bar","optima_sigma","sigma2_y"))
