...
#include "stanExports_blouchOUPredict_v1.h"

RCPP_MODULE(stan_fit4blouchOUPredict_v1_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_blouchOUPredict_v1")
